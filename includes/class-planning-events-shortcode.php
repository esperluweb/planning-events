    ...
    private function render_event($post) {
        ...
        <div class="planning-event" <?php echo wp_kses_post($event_style); ?>>
            ...
            <div class="event-details">
                <h3 class="event-title"><?php echo get_the_title($post); ?></h3>
                <div class="event-meta">
                    <span class="event-date"><?php echo ucfirst(strftime('%A %d %B %Y', $start_datetime->getTimestamp())); ?></span>
                    <span class="event-time">
                        <?php
                        if ($all_day) {
                            echo 'Toute la journée';
                        } else if ($start_date === $end_date) {
                            echo 'de ' . $start_time . ' à ' . $end_time;
                        } else {
                            echo 'Du ' . $start_date . ' à ' . $start_time . ' au ' . $end_date . ' à ' . $end_time;
                        }
                        ?>
                    </span>
